    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__contact">
            <ul>
                ...
                <li>DARMOWA DOSTAWA od 300,00 zł</li>
            </ul>
        </div>
    </div>
    <!-- Humberger End -->
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="header__cart">
                        ...
                        <div class="header__cart__price">item: <span>0,00 zł</span></div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="footer__widget">
                        ...
                        <div class="footer__widget__social">
                            <a href="https://instagram.com/extaz.pl"><i class="fa fa-instagram"></i></a>
                        </div>
                    </div>
                </div>
            </div>
